...
* برای شناسه‌های داخلی سیستم از Date.now() استفاده کردم. این کار تضمین می‌کند که هر رکورد یک امضای زمانی کاملاً اختصاصی داشته باشد و هیچ دو رکوردی (حتی اگر همزمان ثبت شوند) با هم تداخل پیدا نکنند. <br>

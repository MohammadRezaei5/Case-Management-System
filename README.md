...
* به جای اینکه برای هر بخش یک فایل استایل جدید و سنگین بسازم، از کدهای قبلی (مثل چیدمان مدال ویرایش) دوباره استفاده کردم. با این روش، حجم فایل‌های CSS برنامه کمتر شده و سرعت لود شدن بالاتر می‌رود، در حالی که ظاهر هر بخش همچنان اختصاصی و مرتب است.
